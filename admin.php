...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .user-chip { padding: 6px 10px; border-radius: 12px; background: rgba(255,255,255,0.05); border: 1px solid var(--border); color: var(--muted); }
...
<body>
    <header>
        ...
        <div class="header-actions">
            <div class="user-chip">Signed in as <?php echo htmlspecialchars($adminName, ENT_QUOTES, 'UTF-8'); ?></div>
            <a class="button secondary" href="admin_login.php?action=logout">Logout</a>
    ...
    <script>
        ...
        async function loadBookings() {
            ...
            try {
                const res = await fetch('admin_bookings.php', { credentials: 'same-origin' });
        ...
        async function loadReviews() {
            ...
            try {
                const res = await fetch('review.php?action=adminReviews', { credentials: 'same-origin' });
                const data = await res.json();
